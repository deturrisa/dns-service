...
import static org.example.dnsservice.util.TestUtil.ARecordTestData.FRANKFURT_A_RECORD;
import static org.example.dnsservice.util.TestUtil.ARecordTestData.GENEVA_A_RECORD;
import static org.example.dnsservice.util.TestUtil.ARecordTestData.HONG_KONG_A_RECORD_1;
import static org.example.dnsservice.util.TestUtil.ARecordTestData.LA_A_RECORD_1;
import static org.example.dnsservice.util.TestUtil.ARecordTestData.LA_A_RECORD_2;
import static org.example.dnsservice.util.TestUtil.ARecordTestData.NYC_A_RECORD;
import static org.example.dnsservice.util.TestUtil.ARecordTestData.XYZ_A_RECORD;
...
import static org.example.dnsservice.util.TestUtil.LA_CLUSTER_NAME;
import static org.example.dnsservice.util.TestUtil.LA_FRIENDLY_NAME_1;
import static org.example.dnsservice.util.TestUtil.LA_FRIENDLY_NAME_2;
...
import static org.example.dnsservice.util.TestUtil.ServerTestData.FRANKFURT_SERVER;
import static org.example.dnsservice.util.TestUtil.ServerTestData.GENEVA_SERVER;
import static org.example.dnsservice.util.TestUtil.ServerTestData.HONG_KONG_SERVER_1;
import static org.example.dnsservice.util.TestUtil.ServerTestData.LA_SERVER_1;
...
class EntryStoreServiceTest {
  ...
  @Mock private ARecordService aRecordService;

  @Mock private ServerService serverService;

  @InjectMocks private EntryStoreService service;
  ...
  class GetTest {
    ...
    @BeforeEach
    public void setUp() {
      when(serverService.getServers())
          .thenReturn(List.of(GENEVA_SERVER, LA_SERVER_1, FRANKFURT_SERVER, HONG_KONG_SERVER_1));
    }
    ...
    class ServerEntryTest {
      ...
      class AddToRotationTest {
        ...
        public void testMapServersAndIgnoreUnknownARecords() {
          // given
          var singaporeARecord =
              new ARecord("singapore" + DOT_DOMAIN_COM, "2.2.2.2", "sg", 10L, 10L);
      ...
      class RemoveFromRotationTest {
        ...
        @BeforeEach
        public void setUp() {
          when(aRecordService.getARecords())
              .thenReturn(
                  List.of(HONG_KONG_A_RECORD_1, FRANKFURT_A_RECORD, NYC_A_RECORD, GENEVA_A_RECORD));
          when(serverService.getServers())
              .thenReturn(List.of(HONG_KONG_SERVER_1, FRANKFURT_SERVER, NYC_SERVER, GENEVA_SERVER));
        }
      ...
      class AddToAndRemoveFromRotationTest {
        ...
        public void testMapAddToAndRemoveFromRotationEntries() {
          // given
          when(serverService.getServers())
              .thenReturn(List.of(GENEVA_SERVER, LA_SERVER_1, LA_SERVER_2));

          when(aRecordService.getARecords()).thenReturn(List.of(LA_A_RECORD_1, LA_A_RECORD_2));
    ...
    class DnsEntryTest {
      ...
      public void testMapPublishedDnsEntries() {
        // given
        when(serverService.getServers()).thenReturn(List.of(LA_SERVER_1, LA_SERVER_2));

        when(aRecordService.getARecords())
            .thenReturn(List.of(LA_A_RECORD_1, LA_A_RECORD_2, XYZ_A_RECORD));
