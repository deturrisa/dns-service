...
public class PostgresContainerExtension extends ToggleableContainerExtension {
    ...
    static PostgreSQLContainer<?> postgres = new PostgreSQLContainer<>("postgres:12.13")
    ...
    protected void beforeAllInternal(ExtensionContext context) {
        ...
        log.info ("### Postgres container startup finished with properties: {} {} {}",
                POSTGRES_DB, System.getProperty(POSTGRES_DB),
                POSTGRES_USER, System.getProperty(POSTGRES_USER),
                POSTGRES_USER_PASSWORD, System.getProperty(POSTGRES_USER_PASSWORD)
        );
    }
