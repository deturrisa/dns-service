...
public class DnsServiceSST extends BaseSST {
    ...
    public void testShouldRenderServerEntries() throws Exception {
        ...
        //then
        assertServerEntryTable(response);
        assertDnsEntryTable(response);
    }

    private static void assertServerEntryTable(ResultActions resultActions) throws Exception {
    ...
    private static void assertDnsEntryTable(ResultActions resultActions) throws Exception {
        int expectedRowCount = 4;
