...
public class DnsServiceSST extends BaseSST {
    ...
    private static final String DOMAIN_DOT_COM_DOT = "domain.com.";
    ...
    public void testShouldRenderAddToRotationPageAfterUpsert() throws Exception {
        ...
        when(route53AsyncClient.getHostedZone(getHostedZoneRequest)).thenReturn(
                getGetHostedZoneResponse(DOMAIN_DOT_COM_DOT)
        );
