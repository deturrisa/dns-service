...
public class TestUtil {
  ...
  public static class ResourceRecordSetTestData {
    ...
    public static ListResourceRecordSetsResponse createListResourceRecordSetsResponse(
    ...
    public static ResourceRecordSet getSoaResourceRecordSet() {
      return createResourceRecordSet(
          DOT_DOMAIN_COM,
          RRType.SOA,
          Collections.singletonList(
              createResourceRecord(
                  "ns-1243.awsdns-11.org. awsdns-hostmaster.amazon.com. 1 7200 900 1209600 86400")));
    }
    ...
    public static ResourceRecordSet getGenevaAResourceRecordSet() {
      return createAResourceRecordSet(
          SWITZERLAND + DOT_DOMAIN_COM, GENEVA, createIpResourceRecords(List.of(GENEVA_IP)));
    }

    public static ResourceRecordSet getLaAResourceRecordSet() {
      return createAResourceRecordSet(
          USA + DOT_DOMAIN_COM, LA, createIpResourceRecords(List.of(LA_IP_1, LA_IP_2)));
    }
    ...
    public static ResourceRecordSet getFrankfurtAResourceRecordSet() {
      return createAResourceRecordSet(
          GERMANY + DOT_DOMAIN_COM, FRANKFURT, createIpResourceRecords(List.of(FRANKFURT_IP)));
    }

    public static ResourceRecordSet getNycAResourceRecordSet() {
      return createAResourceRecordSet(
          USA + DOT_DOMAIN_COM, NYC, createIpResourceRecords(List.of(NYC_IP)));
    }

    public static ResourceRecordSet getXyzAResourceRecordSet() {
      return createAResourceRecordSet(
          ABC + DOT_DOMAIN_COM, XYZ, createIpResourceRecords(List.of(XYZ_IP)));
    }
    ...
    public static ResourceRecordSet createAResourceRecordSet(
        String name, String setIdentifier, List<ResourceRecord> resourceRecords) {
    ...
    private static ResourceRecordSet createResourceRecordSet(
        String name, RRType type, List<ResourceRecord> resourceRecords) {
      return ResourceRecordSet.builder()
          .name(name)
          .type(type)
    ...
    public static ResourceRecord createResourceRecord(String value) {
      return ResourceRecord.builder().value(value).build();
    }
    ...
    public static List<ResourceRecordSet> getResourceRecordSets(
      ...
      return Stream.concat(
              getNsAndSoaResourceRecordSets().stream(), Arrays.stream(resourceRecordSet))
          .toList();
    }
    ...
    public static ChangeResourceRecordSetsRequest getChangeResourceRecordSetsRequest(
        ChangeAction action, ResourceRecordSet resourceRecordSet) {
              ...
              ChangeBatch.builder()
                  .changes(
                      Stream.of(resourceRecordSet)
                          .map(it -> Change.builder().action(action).resourceRecordSet(it).build())
                          .toList())
                  .build())
          .build();
    }
    ...
    public static GetHostedZoneRequest getGetHostedZoneRequest() {
      return GetHostedZoneRequest.builder().id(HOSTED_ZONE_ID).build();
    }

    public static GetHostedZoneResponse getGetHostedZoneResponse() {
      return GetHostedZoneResponse.builder()
          .hostedZone(HostedZone.builder().name(DOMAIN_DOT_COM_DOT).build())
          .build();
    }

    public static ListResourceRecordSetsRequest getListResourceRecordSetsRequest() {
      return ListResourceRecordSetsRequest.builder().hostedZoneId(HOSTED_ZONE_ID).build();
    }
    ...
    public static ChangeResourceRecordSetsResponse getChangeResourceRecordSetsResponse() {
      return ChangeResourceRecordSetsResponse.builder()
          .changeInfo(ChangeInfo.builder().id(CHANGE_ID).build())
          .build();
    }
  }
  ...
  public static class ServerTestData {
    ...
    public static final Server GENEVA_SERVER =
        new ServerBuilder()
            .id(20)
            .clusterId(5)
    ...
    public static final Server NYC_SERVER =
        new ServerBuilder()
            .id(6)
            .clusterId(2)
            .regionSubdomain(USA)
    ...
    public static final Server LA_SERVER_1 =
        new ServerBuilder()
            .id(1)
            .clusterId(1)
            .regionSubdomain(USA)
    ...
    public static final Server LA_SERVER_2 =
        new ServerBuilder()
            .id(2)
            .clusterId(1)
            .regionSubdomain(USA)
    ...
    public static final Server FRANKFURT_SERVER =
        new ServerBuilder()
            .id(3)
            .clusterId(3)
    ...
    public static final Server HONG_KONG_SERVER_1 =
        new ServerBuilder()
            .id(4)
            .clusterId(4)
    ...
    public static final Server HONG_KONG_SERVER_2 =
        new ServerBuilder()
            .id(5)
            .clusterId(4)
            .regionSubdomain(HONG_KONG)
  ...
  public static class ARecordTestData {
    ...
    public static final ARecord GENEVA_A_RECORD =
        new ARecordBuilder()
    ...
    public static final ARecord NYC_A_RECORD =
        new ARecordBuilder()
    ...
    public static final ARecord LA_A_RECORD_1 =
        new ARecordBuilder()
            .name(USA + DOT_DOMAIN_COM)
            .setIdentifier(LA)
            .ipAddress(LA_IP_1)
    ...
    public static final ARecord LA_A_RECORD_2 =
        new ARecordBuilder()
            .name(USA + DOT_DOMAIN_COM)
            .setIdentifier(LA)
            .ipAddress(LA_IP_2)
    ...
    public static final ARecord FRANKFURT_A_RECORD =
        new ARecordBuilder()
    ...
    public static final ARecord HONG_KONG_A_RECORD_1 =
        new ARecordBuilder()
    ...
    public static final ARecord HONG_KONG_A_RECORD_2 =
        new ARecordBuilder()
            .name(HONG_KONG + DOT_DOMAIN_COM)
            .setIdentifier(HONG_KONG)
            .ipAddress(HONG_KONG_IP_2)
    ...
    public static final ARecord XYZ_A_RECORD =
        new ARecordBuilder()
  ...
  public static class EntityTestData {
    ...
    public static final ServerEntity LA_SERVER_ENTITY_1 =
        new ServerEntity(1, LA_FRIENDLY_NAME_1, LA_IP_1, LA_CLUSTER_ENTITY);
    public static final ServerEntity LA_SERVER_ENTITY_2 =
        new ServerEntity(2, LA_FRIENDLY_NAME_2, LA_IP_2, LA_CLUSTER_ENTITY);

    // geneva
    public static final ClusterEntity GENEVA_CLUSTER_ENTITY =
        new ClusterEntity(5, GENEVA_CLUSTER_NAME, GENEVA);
    public static final ServerEntity GENEVA_SERVER_ENTITY =
        new ServerEntity(20, GENEVA_FRIENDLY_NAME, GENEVA_IP, GENEVA_CLUSTER_ENTITY);

    // nyc
    public static final ClusterEntity NYC_CLUSTER_ENTITY =
        new ClusterEntity(6, NYC_CLUSTER_NAME, NYC);
    public static final ServerEntity NYC_SERVER_ENTITY =
        new ServerEntity(7, NYC_FRIENDLY_NAME, NYC_IP, NYC_CLUSTER_ENTITY);
  }
  ...
  public static class ServerBuilder {
    ...
    public Server build() {
      return new Server(
          id, clusterId, clusterName, regionSubdomain, clusterSubdomain, friendlyName, ipAddress);
    }
  }
